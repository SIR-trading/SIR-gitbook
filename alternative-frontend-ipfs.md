...
The main SIR frontend is available at [https://app.sir.trading](https://app.sir.trading). If it is down or inaccessible, you can use our alternative frontend hosted on IPFS. This minimalistic site lets you connect your wallet, withdraw balances, unstake unlocked SIR, and claim rewards or dividends—all with simple button clicks. It's available at:\
`ipfs://bafybeibsyc7jejntuehvf364t6hk2ehravlojcdfthuuouhoinojl4q6ru`

## How to Access the IPFS Frontend

Since most browsers do not support IPFS by default, here is how to access it:
...
If you cannot install IPFS Desktop, try these public gateways:
...
Once loaded, you will see your TEA, APE, and SIR positions listed with buttons for each action:
...
Each button triggers a transaction—approve it in your wallet, and you are done.
